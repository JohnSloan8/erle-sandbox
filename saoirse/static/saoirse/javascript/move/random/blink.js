...
function blinkController() {
    ...
    let untilNextBlink = controllerObject.blink.nextBlinkCount - mainCount;
    ...
    if ( untilNextBlink <= 0 ) {
        ...
        if ( eyelidObject.bool ) {
            ...
            controllerObject.blink.bool = false; // don't run the countdown agian until the blink has completed
            controllerObject.blink.nextBlinkCount = mainCount + Math.floor( 200 + Math.random() * 240 ); // new countdown until next blink
